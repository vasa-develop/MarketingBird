...
class UnicodeWriter:
    ...
    def writerow(self, row):
        ...
        os.system('./tweet.sh direct-message @' +
                  data.split("'")[1] + ' hey there! we will be sharing new Web 3.0 articles every week. Feel free to subscribe to our posts here: https://simpleaswater.com/signup/')
        #data = data.split("b'")
        #data = data[1].replace("',", "")+data[2].replace("'", "")
...
if __name__ == "__main__":
    ...
    get_friends_descriptions(
        api, FILE_PATH, TWITTER_ACCOUNT, max_users=MAX_USERS)
